...
--
-- Odloži podatke za tabelo `imdb`
--

INSERT INTO `imdb` (`id`, `ime`, `priimek`, `kraj_id`, `zanri`, `ocena`, `filmi`, `nagrade`, `status`, `updated_at`, `created_at`, `deleted_at`) VALUES
...
(11, 'Maja', 'Čebelica', 1, 'ddd', 0, 'eee', 'fff', 1, '2020-05-07 17:27:49', '2020-05-05 15:33:09', '2020-05-07 18:11:53');
...
--
-- Omejitve za tabelo `imdb`
--
ALTER TABLE `imdb`
  ADD CONSTRAINT `imdb_ibfk_1` FOREIGN KEY (`kraj_id`) REFERENCES `imdb_kraji` (`kraj_id`);
COMMIT;
